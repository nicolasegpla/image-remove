...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost:5174", "http://localhost:8000", "http://localhost:4174", "http://localhost:5173", "https://buildtix.site", "http://52.90.156.9:8000"],  # o ["*"] si estás en desarrollo
